...
w = np.where(rmag < 15.)[0] # # repesent the magnitude (higher  = less) this will change the number of data I plot from the catalog
...
x_catalog, y_catalog = deg_to_pixel(w)
